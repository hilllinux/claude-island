...
struct HookEvent: Codable, Sendable {
    ...
    init(sessionId: String, cwd: String, event: String, status: String, provider: AgentProvider? = nil, pid: Int?, tty: String?, tool: String?, toolInput: [String: AnyCodable]?, toolUseId: String?, notificationType: String?, message: String?, transcriptPath: String? = nil) {
